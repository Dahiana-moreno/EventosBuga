        ...
        <header class="masthead">
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    ...
                    <!-- TRABAJAR DESDE AQUÍ EL LOGUIN-->
                    <?php
	    if(empty($_SESSION['email'])) { // comprobamos que las variables de sesión estén vacías        
	?>
                    <div class="container">
                        <div class="d-flex justify-content-center h-100">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form role="form" action="../controlador/loguin.controlador.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="submit" value="Iniciar Sesión" name="enviar" class="btn float-right login_btn"> <br>                                                                          
                                        </div> 
